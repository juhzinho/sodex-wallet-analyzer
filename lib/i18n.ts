...
const en = {
  ...
  "dash.dataAsOf": "Data as of {date}",
  "dash.cachedData": "Cached snapshot — click Refresh for latest trades",
  "dash.partialData": "Still loading — campaign volume may update when scan finishes",
  "dash.lookbackNote": "Volume & charts show last {days} days. PnL & win rate use full position history.",
  "dash.fullHistory": "Complete analysis — all trades & positions included.",
  ...
  "card.weeklyNote": "Campaign week only, not all-time",
  ...
  "progress.fullScan": "Full scan — fetching complete on-chain history...",
  "progress.fastStart": "Fast scan — core metrics first...",
  "progress.tradesRecent": "Fetching last {days} days of trades...",
  "progress.tradesFull": "Fetching full trade history (slow)...",
  "progress.enriching": "Loading spot & extras...",
  "progress.spotFull": "Fetching complete spot history...",
...
const ptBR: Dict = {
  ...
  "dash.refresh": "Atualizar dados",
  "dash.dataAsOf": "Dados de {date}",
  "dash.cachedData": "Snapshot em cache — clique em Atualizar para buscar trades recentes",
  "dash.partialData": "Ainda carregando — volume da campanha pode mudar ao terminar",
  "dash.lookbackNote": "Volume e gráficos mostram os últimos {days} dias. PnL e win rate usam histórico completo de posições.",
  "dash.fullHistory": "Análise completa — todos os trades e posições incluídos.",
  ...
  "card.weeklyNote": "Só a semana da campanha, não o total",
  ...
  "progress.fullScan": "Scan completo — buscando histórico on-chain integral...",
  "progress.fastStart": "Scan rápido — métricas principais primeiro...",
  "progress.tradesRecent": "Buscando trades dos últimos {days} dias...",
  "progress.tradesFull": "Buscando histórico completo (lento)...",
  "progress.enriching": "Carregando spot e extras...",
  "progress.spotFull": "Buscando histórico spot completo...",
...
const es: Dict = {
  ...
  "dash.refresh": "Actualizar datos",
  "dash.dataAsOf": "Datos del {date}",
  "dash.cachedData": "Snapshot en caché — pulsa Actualizar para trades recientes",
  "dash.partialData": "Cargando — el volumen puede cambiar al terminar",
  "dash.lookbackNote": "Volumen y gráficos muestran los últimos {days} días. PnL y win rate usan historial completo de posiciones.",
  "dash.fullHistory": "Análisis completo — todos los trades y posiciones incluidos.",
  ...
  "card.weeklyNote": "Solo semana de campaña, no total",
  ...
  "progress.fullScan": "Escaneo completo — obteniendo historial on-chain integral...",
  "progress.fastStart": "Escaneo rápido — métricas principales primero...",
  "progress.tradesRecent": "Obteniendo trades de los últimos {days} días...",
  "progress.tradesFull": "Obteniendo historial completo (lento)...",
  "progress.enriching": "Cargando spot y extras...",
  "progress.spotFull": "Obteniendo historial spot completo...",
